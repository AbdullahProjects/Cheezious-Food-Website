...
// order a food through watsapp
function sendToWhatsApp(foodName, price) {
    const phoneNumber = "03001398919";
    const message = `Hello, I would like to order : ${foodName}, that's total price is : ${price}`;
